...
public class JoyStickInput : IUserInput
{
    ...
    public MyButton theAxisLT = new MyButton();
    public MyButton theAxisRT = new MyButton();
    ...
    void Update()
    {
        ...
        theAxisLT.Tick(Input.GetAxis(axisLT)>0);
        theAxisRT.Tick(Input.GetAxis(axisRT)>0);
        ...
        rt = theAxisRT.OnPressed;
        lb = buttonLB.OnPressed;
        lt = theAxisLT.OnPressed;
